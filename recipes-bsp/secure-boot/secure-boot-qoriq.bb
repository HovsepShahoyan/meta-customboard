...
python __anonymous () {
    board="ls1012afrwy ls1012ardb ls1021atwr ls1028ardb ls1043ardb ls1046afrwy ls1046ardb ls1088ardb ls1088ardb-pb ls2088ardb lx2160ardbtt lx2160ardb-rev2 lx2162aqds"
    m = d.getVar("MACHINE")
    if m not in board:
...
do_deploy () {
    bbwarn "TT secure boot do_deploy"
